...
add_instruction("MULT", 0x11, 0)
add_instruction("DIV", 0x12, 0)
add_instruction("GR", 0x13, 0)
add_instruction("GREQ", 0x14, 0)
add_instruction("LS", 0x15, 0)
add_instruction("LSEQ", 0x16, 0)
add_instruction("EQ", 0x17, 0)
add_instruction("NEQ", 0x18, 0)
add_instruction("AND", 0x19, 0)
add_instruction("OR", 0x20, 0)
# Stack
add_instruction("PEEK", 0x20, 1)
add_instruction("POKE", 0x21, 1)
add_instruction("POP", 0x22, 0)
add_instruction("PUSH", 0x23, 1)
# Control transfer
